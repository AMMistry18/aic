...
This is the SC sibling of :mod:`aic_model.insertion.sfp_plug_pose`.  It exists so the SC
...
eight local keypoints from :mod:`aic_model.insertion.sc_plug_pose_geometry` and a
...
def default_sc_plug_pose_weights() -> Path | None:
    ...
    # aic_model/aic_model/insertion/sc_plug_pose.py -> repository root.
