...
#   * contract -- shared pose and action geometry retained by the
...
class InsertionPolicy(VisualGapRecoveryMixin, Policy):
    ...
    def _run(self, task, get_observation, move_robot, send_feedback):
        ...
        # Latest direct plug-to-port controller. The legacy fixed-bias script
        # remains below for provenance but is unreachable in this release.
        ...
        for step in range(MAX_RL_STEPS):
            ...
            if CONTROL_MODE == "guided":
                ...
                from .contract import deploy_action_delta
